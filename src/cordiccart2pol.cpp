...
#pragma HLS INTERFACE mode=s_axilite port=x  depth=1000
#pragma HLS INTERFACE mode=s_axilite port=y  depth=1000
#pragma HLS INTERFACE mode=s_axilite port=theta  depth=1000
#pragma HLS INTERFACE mode=s_axilite port=r depth=1000
